const Footer = () => {
  return (
    ...
    <footer className="fixed bottom-0 left-0 w-full bg-primary text-black py-14 px-4 md:px-8 lg:px-16 z-0">
      {/* Three-Column Grid */}
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center border border-black">
            ...
            <input
              type="email"
              id="email"
              className="text-[1.125rem] font-normal px-6 py-3 w-full bg-transparent text-white border-none focus:ring-0 focus:outline-none"
              required
            />
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              className="bg-white text-black px-6 py-3 text-[1.25rem] font-semibold rounded-full hover:bg-gray-200 transition-colors w-fit"
            >
              Subscribe
            </button>
          </div>
